...
class RibbonPage(QWidget):
    def __init__(self, parent=None):
        ...
        self.content_widget.setFixedHeight(84)
        self.content_widget.setStyleSheet(f"background: {RIBBON_BG};")
        
        self.main_layout = QHBoxLayout(self.content_widget)
        # Üstte 24 px'lik başlık şeridi var; düğmeler onun 13 px altında başlar.
        self.main_layout.setContentsMargins(4, 13, 4, 9)
...
class RibbonWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._page_area.setFixedHeight(86)
    ...
    def _apply_height(self):
        ...
        page = 0 if getattr(self, "_collapsed", False) else 86
